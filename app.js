...
const defaultData = {
  ...
  overviewStats: [
    ...
    { value: '26~30대', label: '세보 원문 직접 확인', meta: '정호일 · 정무상 · 정병운 · 정한채 · 정현규' },
    { value: '1~5파', label: '원당제실 회의 구분', meta: '매년 4월 둘째 주 대표자 협의 구조' }
  ],
  branchIntro: '영일정씨는 영일·연일·오천을 관향으로 전해 오는 정씨 문중으로, 전승상 시조는 정종은입니다. 공개 문헌에서는 크게 지주사공계와 감무공계의 두 계열로 정리되며, 본 홈페이지는 그 가운데 지주사공계를 중심으로 구성하였습니다. 지주사공계는 고려 전기의 문신 정습명을 중시조로 받들며, 문한의 전통, 절의, 충의, 향촌 교육의 정신을 함께 계승한 계통으로 이해됩니다. 영천 지역 공개 문헌에서는 정문예에서 좌랑 정치소, 생원 정이상, 훈도 정굉, 감찰 정인개를 거쳐 복재 정담으로 이어지는 흐름이 확인되며, 복재 정담 이후의 후손 가운데 사용자 직계는 세보 원문을 통해 27대 정무상, 28대 정병운, 29대 정한채, 30대 정현규로 직접 확인됩니다. 26대 정호일은 세보 면 배열상 가장 유력한 상계 인물로 정리하되, 후일 추가 대조 가능성을 열어 두었습니다.',
  branchList: [
  ...
  treeNodes: [
    ...
    { id: 'n10', name: '정호일', hanja: '鄭浩日', gen: '26대', branch: '사용자 직계', verified: 'family', note: '복재공파세보 66면에서 직접 확인되는 사용자 직계 증조부 세대입니다.' },
