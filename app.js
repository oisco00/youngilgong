const STORAGE_KEY = 'youngil-jeong-clan-site-v2';
...
const defaultData = {
  ...
  treeNodes: [
    ...
    { id: 'n29', name: '정한채', hanja: '鄭漢채', gen: '29대', branch: '직계', verified: 'family', note: '1961.02.06 출생. 현 (주)동양정보시스템 대표.' },
  ...
  directPeople: [
    { title: '27대 정용범', body: '직계 할아버지. 추후 출생지, 생몰년, 공적, 문중 활동을 추가 입력할 수 있도록 확장 가능.' },
    { title: '28대 정병운', body: '진량읍 선화리 거주. 1931.10.26(음) 출생, 2009.11.11(음) 별세. 진량새마을금고 설립 및 이사장 역임.' },
    { title: '29대 정한채', body: '1961.02.06 출생. 현 (주)동양정보시스템 대표. 문중 홈페이지에서 직계 위치와 공적을 함께 기록.' },
    { title: '30대 정현규', body: '경상북도교육청 기록연구사 재임. 29대 정한채에서 이어지는 30대 직계 후손으로 문중 기록과 가계 계승의 현재 축을 이룸.' }
  ],
  myAchievements: [
    { title: '우수숙련기술인', detail: '산업현장 실무경험과 숙련기술 전승 성과를 대표하는 주요 공적.' },
    { title: '대한민국명장', detail: '정보처리 분야 숙련기술의 최고 수준을 대외적으로 인정받은 이력.' },
    { title: '대한민국산업현장교수', detail: '기업 현장 코칭, 스마트공장, DX, AI 교육 및 컨설팅 활동을 수행.' }
  ],
  wondangInfo: [
    ...
    return `
      <article class="media-card">
        ...
        <div class="media-body">
          ...
          <div class="media-meta">파일명: ${escapeHtml(item.file || '')}</div>
        </div>
      </article>
    `;
